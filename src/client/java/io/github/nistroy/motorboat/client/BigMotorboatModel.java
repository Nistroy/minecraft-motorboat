...
/**
 * Coque de la grande barque : barque vanilla agrandie, 48 × 28 px (3 × 1,75 bloc), proue en +X.
 *
    ...
    public static LayerDefinition createBodyModel() {
        ...
        hull.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(0, 0)
                        .addBox(-24F, 0F, -13F, 38F, 1F, 26F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "fond_etrave_1",
                CubeListBuilder.create()
                        .texOffs(128, 0)
                        .addBox(14F, 0F, -11.5F, 2F, 1F, 23F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "fond_etrave_2",
                CubeListBuilder.create()
                        .texOffs(178, 0)
                        .addBox(16F, 0F, -9F, 2F, 1F, 18F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "fond_etrave_3",
                CubeListBuilder.create()
                        .texOffs(218, 0)
                        .addBox(18F, 0F, -6.5F, 2F, 1F, 13F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "fond_etrave_4",
                CubeListBuilder.create()
                        .texOffs(0, 27)
                        .addBox(20F, 0F, -4F, 2F, 1F, 8F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "fond_etrave_5",
                CubeListBuilder.create()
                        .texOffs(20, 27)
                        .addBox(22F, 0F, -1.5F, 1.5F, 1F, 3F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "borde_bd",
                CubeListBuilder.create()
                        .texOffs(30, 27)
                        .addBox(-24F, -6F, 12F, 38F, 6F, 2F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "borde_td",
                CubeListBuilder.create()
                        .texOffs(110, 27)
                        .addBox(-24F, -6F, -14F, 38F, 6F, 2F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "tableau",
                CubeListBuilder.create()
                        .texOffs(190, 27)
                        .addBox(-24F, -6F, -12F, 2F, 6F, 24F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "liston_bd",
                CubeListBuilder.create()
                        .texOffs(0, 57)
                        .addBox(-24F, -7F, 11.5F, 38F, 1F, 2.5F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "liston_td",
                CubeListBuilder.create()
                        .texOffs(82, 57)
                        .addBox(-24F, -7F, -14F, 38F, 1F, 2.5F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "banquette_poupe",
                CubeListBuilder.create()
                        .texOffs(164, 57)
                        .addBox(-24F, -8F, -11.5F, 4F, 2F, 23F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "pont_avant_1",
                CubeListBuilder.create()
                        .texOffs(218, 57)
                        .addBox(18.5F, -7F, -6F, 1.5F, 1F, 12F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "pont_avant_2",
                CubeListBuilder.create()
                        .texOffs(0, 82)
                        .addBox(20F, -7F, -3.5F, 2F, 1F, 7F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "pont_avant_3",
                CubeListBuilder.create()
                        .texOffs(18, 82)
                        .addBox(22F, -7F, -2F, 1.5F, 1F, 4F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "etrave",
                CubeListBuilder.create()
                        .texOffs(30, 82)
                        .addBox(21.5F, -9F, -2.75F, 2.5F, 9F, 5.5F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "banc_milieu_ar",
                CubeListBuilder.create()
                        .texOffs(48, 82)
                        .addBox(-12F, -2F, -10F, 4F, 2F, 20F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "banc_milieu_av",
                CubeListBuilder.create()
                        .texOffs(96, 82)
                        .addBox(0F, -2F, -10F, 4F, 2F, 20F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "banc_etrave",
                CubeListBuilder.create()
                        .texOffs(144, 82)
                        .addBox(11F, -2F, -5F, 4F, 2F, 10F),
                PartPose.ZERO);
        hull.addOrReplaceChild(
                "proue_bd",
                CubeListBuilder.create()
                ...
                PartPose.offsetAndRotation(14F, 0F, 13F,
                        0.0F, 0.9068F, 0.0F));
        hull.addOrReplaceChild(
                "proue_td",
                CubeListBuilder.create()
        ...
        // UV ne sont jamais échantillonnées, seules ses dimensions comptent (intérieur x -22..14, z ±12).
        root.addOrReplaceChild(
                WATER_PATCH,
                CubeListBuilder.create().texOffs(0, 0).addBox(-22.0F, -12.0F, 0.0F, 36.0F, 24.0F, 0.0F),
